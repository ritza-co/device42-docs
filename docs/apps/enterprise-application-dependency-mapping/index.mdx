...
Start by discovering your Windows and Linux environments without ADM, **Discover Services** and **Discover Applications** options enabled. After discovering your environment, you then identify the specific Application Servers you want to perform the deeper Services and Application  discovery on.
