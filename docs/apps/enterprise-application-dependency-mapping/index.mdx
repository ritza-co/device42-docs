...
Once you’ve discovered your inventory, analyze the list of servers and identify the servers you wish to include in a discovery job. This ADM-enabled discovery job is orientated towards the creation of Application Groups (detailed in the section that follows).
...
Create a Business Service (under **Applications > Business Services**) by adding an Application Group to the Business Service.
