...
Go to the **Software and Applications** sections and enable **Discover Services** and **Discover Software**. The next time the discovery job runs, it will discovery Services and Applications on the systems. 
