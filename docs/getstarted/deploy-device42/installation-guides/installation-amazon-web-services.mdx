...
## Deploy Device42 from the AWS Marketplace
...
- Click **Create a key pair in EC2** to generate a key. See the [Generate a New AWS Key Pair](#generate-a-new-aws-key-pair-for-ssh-access) section for more help with this step.
...
### Generate a New AWS Key Pair for SSH Access
...
### Access the Appliance Manager — AWS Marketplace Installation
...
## Deploy a Downloaded Image to an AWS Instance — Manual Installation
...
### Access the Appliance Manager — Manual Installation
...
### Back Up and Restore Device42 Data on AWS
...
### Monitor and Check Device42 Health on AWS
...
### Configure High Availability for Device42 on AWS
