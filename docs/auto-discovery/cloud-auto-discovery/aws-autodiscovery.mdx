...
**Note:** See [Defining AWS Roles](#defining-aws-roles) below for instructions on creating the AWS Roles that Device42 displays for AWS cloud autodiscovery jobs.
