...
Similar changes were made to three different versions of the `Devices` task, which differ by DOQL version and Device42 version constraints.

### DOQL v2 (d42_min_version="19.04.00")
...
- The `hw_model` field element was changed from:
...
### DOQL v2 (d42_max_version="19.03.99", d42_min_version="16.19.00")

The same changes were made within this `Devices` task:
...
### DOQL v1 (d42_max_version="16.18.02")
