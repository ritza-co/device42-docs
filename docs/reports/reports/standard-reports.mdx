...
## View, Export, and Edit Standard Reports

Click **Display on Screen** to view the report results and apply filters to the data grid. The following actions are available from this view:
