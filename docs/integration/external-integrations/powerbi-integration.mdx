...
- The Device42 ODBC driver installed, and the requirements in the [ODBC System Requirements](integration/external-integrations/odbc-driver-integration.mdx) section of the ODBC driver page met
