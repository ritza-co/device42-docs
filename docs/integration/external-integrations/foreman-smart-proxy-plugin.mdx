...
- A running Foreman installation, with root or `sudo` access to install the `foreman-proxy` package and edit its settings files
- A running Device42 instance with subnets and IP addresses already defined
