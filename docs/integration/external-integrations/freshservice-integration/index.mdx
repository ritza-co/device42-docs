...
- Administrator access to Device42 to configure **Tools > Integrations > Cloud Services** and **Tools > Integrations > External Integrations**
...
- The same **Cloud Connector** region selected in both Device42 and the Freshservice app
