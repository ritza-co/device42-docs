...
This page is for administrators who already run Nagios and want the health of their Device42 appliance monitored alongside the rest of their infrastructure. By the end, Nagios reports Device42 database size, disk, memory, and CPU status as standard service checks.

## Prerequisites

Before installing the plugin, make sure you have:
- A running Nagios server with root access to its plugin and configuration directories
- Network connectivity from the Nagios server to your Device42 appliance
