...
_Seamless ITSM and CMDB integration._
...
- A single login page for accessing both Device42 and Freshservice.
  ...
  <ThemedImage
    ...
    sources={{
      light: useBaseUrl(
        "/assets/images/freshservice-integration/freshworks-login-button-light.png"
      ),
      dark: useBaseUrl(
        "/assets/images/freshservice-integration/freshworks-login-button-dark.png"
      ),
    }}
  />
...
3. Select your **Cloud Connector** location or environment. It's set to **USA** by default.
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         "/assets/images/freshservice-integration/cloud-services-settings-light-2.png"
       ),
       dark: useBaseUrl(
         "/assets/images/freshservice-integration/cloud-services-settings-dark-2.png"
       ),
     }}
   />
...
4. You can optionally select **Enable Freshworks SSO** to activate single sign-on (SSO). We recommend using this feature for a seamless login experience when working with the integration.
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         "/assets/images/freshservice-integration/add-external-integration-light.png"
       ),
       dark: useBaseUrl(
         "/assets/images/freshservice-integration/add-external-integration-dark.png"
       ),
     }}
   />
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         "/assets/images/freshservice-integration/admin-email-light.png"
       ),
       dark: useBaseUrl(
         "/assets/images/freshservice-integration/admin-email-dark.png"
       ),
     }}
   />
...
5. Click **Save** and copy the **Verification Token** from the table on the External Integrations list page.
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         "/assets/images/freshservice-integration/verification-token-light.png"
       ),
       dark: useBaseUrl(
         "/assets/images/freshservice-integration/verification-token-dark.png"
       ),
     }}
   />
...
4. Click **View Asset in Device42** to be redirected to the asset in Device42.
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         "/assets/images/freshservice-integration/unmapped-view-in-d42-light.png"
       ),
       dark: useBaseUrl(
         "/assets/images/freshservice-integration/unmapped-view-in-d42-dark.png"
       ),
     }}
   />
...
3. Search the returned JSON for the field label you are interested in to verify the field name.
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         "/assets/images/freshservice-integration/verify-field-name-light.png"
       ),
       dark: useBaseUrl(
         "/assets/images/freshservice-integration/verify-field-name-dark.png"
       ),
     }}
   />
...
- Purchase Line Item in Device42:
  ...
  <ThemedImage
    ...
    sources={{
      light: useBaseUrl(
        "/assets/images/freshservice-integration/line-item-example-d42-light.png"
      ),
      dark: useBaseUrl(
        "/assets/images/freshservice-integration/line-item-example-d42-dark.png"
      ),
    }}
  />
...
- Warranty items in Device42:
  ...
  <ThemedImage
    ...
    sources={{
      light: useBaseUrl(
        "/assets/images/freshservice-integration/warranty-items-d42-light.png"
      ),
      dark: useBaseUrl(
        "/assets/images/freshservice-integration/warranty-items-d42-dark.png"
      ),
    }}
  />
