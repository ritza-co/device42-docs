...
For help installing Device42, head over to the Device42 documentation: [https://docs.device42.com](https://docs.device42.com).

1\. The [Getting Started with Installation](getstarted/deploy-device42/index.mdx) section is a great place to begin.
