...
The Device42 Appliance Manager runs on port 4242 (HTTP by default; enable HTTPs within) to manage various Device42 Administrative functions. You can do backups & restores, manage HTTPS certificates, Restart/Stop the application, generate logs or SNMPwalks for tech support, and more. The following topics are covered in this section:
