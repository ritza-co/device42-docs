...
**Transcript**  
_Hi, this is Marc from Device42. The topic of this video is device URLs. Device URLs enable quick and convenient access to device resources via telnet, ssh, https, ftp, etc. This feature is available for all devices, and as seen here it is located on the "Other Tab" of the device detail page._
